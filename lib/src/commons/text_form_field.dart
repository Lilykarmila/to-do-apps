            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                  borderSide: BorderSide(color: widget.borderColor ?? AppColorTheme.blueColor300),
                ...
                focusedBorder: OutlineInputBorder(
                  borderSide: BorderSide(color: widget.focusColor ?? AppColorTheme.blueColor500),
                  borderRadius: BorderRadius.circular(widget.borderRadius ?? 12),
                ),
                errorBorder: OutlineInputBorder(
                  borderSide: BorderSide(color: widget.errorColor ?? AppColorTheme.blueColor500),
                  borderRadius: BorderRadius.circular(widget.borderRadius ?? 12),
                ),
              ),
            ),
